...
struct XMLGUI: public Application {
    ...
    //{
    //    return ed::NodeId(Counter::GetNextId());
    //}

    ed::LinkId GetNextLinkId()
    {
        return ed::LinkId(Counter::GetNextId());
    }
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "InputAction Fire", ImColor(255, 128, 128));
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "", PinType::Delegate);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Pressed", PinType::Flow);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Released", PinType::Flow);

        m_Nodes.back().assemble();
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Branch");
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "In 1", PinType::Flow);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Input 2", PinType::Bool);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Out 1", PinType::Flow);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Output 2", PinType::Flow);
    ...
    Node* SpawnDoNNode()
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Do N");
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Enter", PinType::Flow);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "N", PinType::Int);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Reset", PinType::Flow);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Exit", PinType::Flow);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Counter", PinType::Int);
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "OutputAction");
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Sample", PinType::Float);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Condition", PinType::Bool);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Event", PinType::Delegate);
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Print String");
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "In String", PinType::String);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "", ImColor(128, 195, 248));
        m_Nodes.back().Type = NodeType::Simple;
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Message", PinType::String);
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Set Timer", ImColor(128, 195, 248));
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Object", PinType::Object);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Function Name", PinType::Function);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Time", PinType::Float);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Looping", PinType::Bool);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
    ...
    Node* SpawnLessNode()
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "<", ImColor(128, 195, 248));
        m_Nodes.back().Type = NodeType::Simple;
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Float);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Float);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "", PinType::Float);
    ...
    Node* SpawnWeirdNode()
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "o.O", ImColor(128, 195, 248));
        m_Nodes.back().Type = NodeType::Simple;
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Float);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "", PinType::Float);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "", PinType::Float);
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Single Line Trace by Channel", ImColor(255, 128, 64));
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Start", PinType::Flow);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "End", PinType::Int);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Trace Channel", PinType::Float);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Trace Complex", PinType::Bool);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Actors to Ignore", PinType::Int);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Draw Debug Type", PinType::Bool);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "Ignore Self", PinType::Bool);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Out Hit", PinType::Float);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "Return Value", PinType::Bool);
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Sequence");
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Move To");
        m_Nodes.back().Type = NodeType::Tree;
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Random Wait");
        m_Nodes.back().Type = NodeType::Tree;
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
    ...
    Node* SpawnComment()
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Test Comment");
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Transform");
    ...
    {
        m_Nodes.emplace_back(Counter::GetNextId(), "Group");
        m_Nodes.back().Type = NodeType::Houdini;
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
        m_Nodes.back().Inputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
        m_Nodes.back().Outputs.emplace_back(Counter::GetNextId(), "", PinType::Flow);
            ...
            for (auto& node : m_Nodes)
            {
                ...
                builder.Begin(node.ID);
                    ...
                    for (auto& output : node.Outputs)
                    {
                        ...
                        if (!output.Name.empty())
                        {
                            ImVec2 sz = ImGui::CalcTextSize(output.Name.c_str());
                            ImVec2 cursor = ImGui::GetCursorPos();
                            ImVec2 final_cursor_pos = ImGui::GetCursorPos();
                            ImGui::SetCursorPos(cursor + ImVec2(240 - sz.x, sz.y));
                            ImGui::TextUnformatted(output.Name.c_str());
                    ...
                    if (ed::QueryNewLink(&startPinId, &endPinId))
                    {
                        ...
                        if (startPin && endPin)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    m_Links.emplace_back(Link(Counter::GetNextId(), startPinId, endPinId));
                ...
                if (auto startPin = newNodeLinkPin)
                {
                    ...
                    for (auto& pin : pins)
                    {
                        if (CanCreateLink(startPin, &pin))
                        {
                            ...
                            m_Links.emplace_back(Link(Counter::GetNextId(), startPin->ID, endPin->ID));
                            m_Links.back().Color = GetIconColor(startPin->Type);
