    ...
    public Application
{
    ...
    Node* SpawnBranchNode()
    {
        ...
        m_Nodes.back().Inputs.emplace_back(GetNextId(), "In 1", PinType::Flow);
        m_Nodes.back().Inputs.emplace_back(GetNextId(), "Input 2", PinType::Bool);
        m_Nodes.back().Outputs.emplace_back(GetNextId(), "Out 1", PinType::Flow);
        m_Nodes.back().Outputs.emplace_back(GetNextId(), "Output 2", PinType::Flow);
